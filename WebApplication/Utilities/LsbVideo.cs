...
namespace WebApplication.Utilities
{
    public class LsbVideo
    {
        ...
        public void HideAvi(byte[] vid, String bin)
        {
        ...
        public byte[] SeekAvi(byte[] vid)
        {
            var bitsToProcess = GetByteCountAvi(vid)*8;
            string binText=null;
        ...
        public byte[] ExtractKeyAvi(byte [] vid)
        {
            string binText = null;
            var bytesToSkip = GetByteCountAvi(vid);
        ...
        public byte[] ExtractIvAvi(byte [] vid)
        {
            string binText = null;
            var bytesToSkip = GetByteCountAvi(vid);
        ...
        static int GetByteCountAvi(byte[] vid)
        {
